...
exports.signup = exports.logout = exports.login = exports.forgotPassword = exports.resetPassword = void 0;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(password, passwordConfirm) {
    var token, result;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PUT",
              url: "".concat(BASE_URL, "/users/resetPassword/").concat(token),
              data: {
                password: password,
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "".concat(BASE_URL, "/users/forgotPassword"),
              data: {
                email: email
              }
            });
          ...
          case 3:
            ...
            if (result.data.status == "success") {
              (0, _alerts.showAlert)("success", "A rest token was sent to the email.");
            }
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)("error", "Some error occured try again!!");
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "".concat(BASE_URL, "/users/signup"),
              data: user
            });
...
exports.updateUserSettings = exports.updateUser = exports.deleteRecord = void 0;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(resource, id) {
    var result;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            try {
              result = (0, _axios.default)({
                method: "DELETE",
                url: "".concat(BASE_URL, "/").concat(resource, "/").concat(id)
              });

              if (result.data.status == "success") {
                (0, _alerts.showAlert)("success", "Record Deleted Successfully!");
                redirectTo("/manage/".concat(resource));
              }
            } catch (error) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PUT",
              url: "".concat(BASE_URL, "/users/").concat(user.id),
              data: {
                email: user.email,
                name: user.name,
                role: user.role
          ...
          case 3:
            ...
            if (result.data.status == "success") {
              (0, _alerts.showAlert)("success", "User Update Successfully!");
...
function () {
  var _ref3 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(data, type) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            url = type == "password" ? "".concat(BASE_URL, "/users/updatePassword") : "".concat(BASE_URL, "/users/updateMe");
            _context3.next = 4;
            return (0, _axios.default)({
              method: "PUT",
              url: url,
  ...
  return function updateUserSettings(_x4, _x5) {
    return _ref3.apply(this, arguments);
  };
}();
...
var stripe = Stripe("pk_test_yshOEdaWaqrKpfqGw00ciGdQ00HpY2cmHZ");
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoidGhlbXVkYXNzYXIiLCJhIjoiY2p6czI1azZmMHl0ajNqcGZhMmVvMXhjeCJ9.o4TNQp13B4U7nA0NE-LlBg";
  var map = new mapboxgl.Map({
    container: "map",
    style: "mapbox://styles/themudassar/cjzs2mirg1v7a1cl5b3tw3g1o",
    scrollZoom: false // center: [74.29352279999999, 31.5273998],
    // zoom: 18
  ...
  locations.forEach(function (loc) {
    ...
    el.className = "marker"; // add the marke to the map
...
},{"process":"../../node_modules/process/browser.js"}],"../../node_modules/bootbox/bootbox.all.js":[function(require,module,exports) {
var define;
/*! @preserve
 * bootbox.js
 * version: 5.3.2
...
var _bootbox = _interopRequireDefault(require("bootbox"));
...
var editUserForm = document.querySelector(".form--user-update");
...
var forgotPassForm = document.querySelector(".form--forgotPassword");
...
if (deleteRecord) {
  deleteRecord.addEventListener("click", function (e) {
    ...
    _bootbox.default.confirm("Are you sure you want to delete Record?", function (result) {});
  });
}
...
if (resetPassForm) {
  resetPassForm.addEventListener("submit",
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return (0, _auth.resetPassword)(password, confirmPassword);
...
if (forgotPassForm) {
  forgotPassForm.addEventListener("submit",
  /*#__PURE__*/
  function () {
    var _ref2 = _asyncToGenerator(
    /*#__PURE__*/
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 6:
              ...
              document.querySelector(".btn--forgotPassword").innerHTML = "Send Reset Link";
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 7;
              return (0, _user.updateUserSettings)({
...
if (updateUserForm) {
  updateUserForm.addEventListener("submit", function (e) {
    ...
    console.log(form.getAll("name"), form.getAll("email"), form.getAll("photo"));
    (0, _user.updateUserSettings)(form, "data");
  });
}
